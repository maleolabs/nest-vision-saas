...
REM --- Ensemble fallback (pyTesseract -> native Tesseract -> RapidOCR -> PaddleOCR) ---
set "OCR_ENSEMBLE_FALLBACK=true"
set "OCR_CONF_THRESHOLD=55"
set "OCR_TIME_BUDGET=60"

REM --- PaddleOCR fallback (legacy, prefer Rapid) ---
set "OCR_PADDLE_ENABLED=false"
set "OCR_PADDLE_SCRIPT=opt/app/ocr/paddle_ocr.py"

REM --- RapidOCR ONNX fallback (preferred untuk KTP buram) ---
set "OCR_RAPID_ENABLED=true"
set "OCR_RAPID_SCRIPT=opt/app/ocr/rapid_ocr.py"

REM --- Super-resolution (blur ekstrem, capped 2200px) ---
set "OCR_SR_ENABLED=true"
set "ESRGAN_MODEL="
...
set "OCR_TIME_BUDGET=%OCR_TIME_BUDGET%"
set "OCR_PADDLE_ENABLED=%OCR_PADDLE_ENABLED%"
set "OCR_PADDLE_SCRIPT=%OCR_PADDLE_SCRIPT%"
set "OCR_RAPID_ENABLED=%OCR_RAPID_ENABLED%"
set "OCR_RAPID_SCRIPT=%OCR_RAPID_SCRIPT%"
